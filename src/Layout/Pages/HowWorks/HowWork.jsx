const HowWork = () => {
  return (
    <div className="my-16 lg:my-36">
      <h2 className="text-3xl lg:text-4xl uppercase text-center mb-10 lg:mb-20  text-white font-Inter font-extrabold">
      ...
      <div className="flex lg:flex-row flex-col gap-10">
        <div className="border transition-all duration-150 hover:border-[#EB3656] p-10 rounded-xl">
          ...
          ></img>
          <h2 className="text-white font-Inter font-bold mt-7 mb-3 text-2xl text-center">
            Choose Plan
          </h2>

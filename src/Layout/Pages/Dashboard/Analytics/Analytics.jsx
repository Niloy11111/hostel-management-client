...
const Analytics = () => {
    ...
    useEffect( () => {
        axios.get('https://hostel-management-server-six.vercel.app/payments')
        .then(res => {
            setPlans(res.data)
        })
    } , [])
    ...
    return (
        <div>
         <h2 className="text-4xl font-inter font-semibold text-center">MEMBERSHIP ANALYTICS</h2>
         <h2 className="text-xl font-semibold text-center text-red-400 my-2">__Statistics of Meal Plan__</h2>
